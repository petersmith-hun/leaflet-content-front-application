...
/**
 * Unit tests for {@link HomePageContentRequestAdapter}.
 *
 * @author Peter Smith
 */
...
public class HomePageContentRequestAdapterTest extends AbstractParallalContentRequestAdapterBaseTest {
    ...
    @InjectMocks
    private HomePageContentRequestAdapter adapter;

    @Test
    public void shouldGetContentReturnWithSuccess() throws CommunicationFailureException {

        // given
        given(entryBridgeService.getPageOfPublicEntries(PAGE_NUMBER, ITEM_LIMIT_ON_PAGE, ORDER_BY, ORDER_DIRECTION))
    ...
    public void shouldGetContentReturnWithEmptyResponse() throws CommunicationFailureException {
        ...
        doThrow(CommunicationFailureException.class).when(entryBridgeService)
                .getPageOfPublicEntries(PAGE_NUMBER, ITEM_LIMIT_ON_PAGE, ORDER_BY, ORDER_DIRECTION);
        givenFailedFilteringDataRetrieval();
    ...
    public void shouldGetIdentifierReturnProperValue() {
        ...
        assertThat(result, equalTo(ContentRequestAdapterIdentifier.HOME_PAGE));
    }
